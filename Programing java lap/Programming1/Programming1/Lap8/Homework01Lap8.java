/**Homework01. Write a method that returns the number of days in a year using the 
following header: 
public static int numberOfDaysInAYear(int year) 
Write a test program that displays the number of days in year from 2000 to 2010. The 
following figure explain whether a year is a leap or not. Use to show the number of the 
days in the year */
/*
