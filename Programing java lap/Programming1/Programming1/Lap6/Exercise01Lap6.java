/**Exercise01. Write a Java program that reads an unspecified number of integers, 
determines how many positive and negative values have been read, and computes the 
total and average of the input values (not counting zeros). Your program ends with the 
input 0. Display the average as a floating-point number */
import java.util.Scanner;

public class Exercise01Lap6{
	public static void main(String[] args) {
		...
		// let  user to enter an integer or 0 to exit
